angular.module('classeur.opt.commenting', [])
	.directive('clCommentingGutter', function($timeout, clCommentingSvc) {
		return {
			restrict: 'E',
			templateUrl: 'opt/commenting/commentingGutter.html',
			scope: true,
			link: function(scope) {
				scope.commentingSvc = clCommentingSvc;
				clCommentingSvc.contentDao = scope.currentFileDao.contentDao;
	...
	.directive('clCommentingButton', function(clCommentingSvc) {
		return {
			restrict: 'E',
			templateUrl: 'opt/commenting/commentingButton.html',
			link: function(scope) {
	...
	.directive('clDiscussion', function(clCommentingSvc, clEditorLayoutSvc, clDraggablePanel) {
		return {
			restrict: 'E',
			templateUrl: 'opt/commenting/discussion.html',
			scope: true,
	...
	.factory('clCommentingSvc', function(clEditorSvc, clEditorLayoutSvc, clSettingSvc) {
		...
		function updateDiscussions() {
			...
			angular.forEach(commentingSvc.contentDao.discussions, function(discussionDao) {
				var discussion = new Discussion(discussionDao, commentingSvc.contentDao);
