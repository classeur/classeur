angular.module('classeur.optional.commenting', [])
	.directive('clCommentingGutter', function($timeout, clCommentingSvc) {
		return {
			restrict: 'E',
			templateUrl: 'optional/commenting/commentingGutter.html',
			scope: true,
			link: function(scope) {
	...
	.directive('clCommentingButton', function(clCommentingSvc) {
		return {
			restrict: 'E',
			templateUrl: 'optional/commenting/commentingButton.html',
			link: function(scope) {
	...
	.directive('clDiscussion', function(clCommentingSvc, clEditorLayoutSvc, clDraggablePanel) {
		return {
			restrict: 'E',
			templateUrl: 'optional/commenting/discussion.html',
			scope: true,
